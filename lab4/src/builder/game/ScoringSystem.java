/**
 * Não consegui fazer o game, pois da forma pela qual originalmente pretendi
 * fazer, cabou exigindo muitas alterções e no geral trabalhoso, então fiz
 * apenas uma pontuação a medida que o personagem vai sendo criado, e não um
 * jogo em si.
 */
...
// attributes.getIntelligence() + attributes.getWisdom() +
